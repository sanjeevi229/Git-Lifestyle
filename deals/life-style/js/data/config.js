...
const CONFIG = {
  ...
  categories: [
    ...
    { id: 'entertainment', label: 'Good Times',    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="2" width="20" height="20" rx="2.18"/><path d="m10 15 5-3-5-3z"/></svg>', iconImg: 'assets/png_1024/good_times.png', color: '#7C3AED' },
  ...
  stories: [
    ...
    },
    {
      id: 'airport',
      label: 'Airport',
      thumbnail: 'https://images.unsplash.com/photo-1569154941061-e231b4725ef1?w=200&q=80',
      route: '/airport',
      color: ['#6366F1', '#4F46E5'],
      badge: 'VIP',
      slides: [
