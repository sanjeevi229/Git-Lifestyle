...
const CONFIG = {
  ...
  cardBenefitIcons: [
    ...
    { id: 'concierge', label: 'Concierge',            icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M2 18h20"/><path d="M12 4v2"/><path d="M12 6a8 8 0 0 1 8 8v4H4v-4a8 8 0 0 1 8-8z"/><circle cx="12" cy="4" r="1"/></svg>', iconImg: 'assets/png_1024/concierge.png' },
