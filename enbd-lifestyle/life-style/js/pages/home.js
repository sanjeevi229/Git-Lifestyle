...
const HomePage = {
  ...
  render() {
    ...
    const benefitIcons = CONFIG.cardBenefitIcons.map(b => `
      <div class="benefit-icon-card" onclick="Router.navigate('/card-benefits')">
    ...
    return `
      <div class="page">
        ...
        <main class="page__main page__main--full">
          ...
          <div class="container">
            <div class="home-section" style="padding-bottom:0;padding-top:var(--space-lg)">
              <h2 class="page-title">
                Experiences we think you'll love
              </h2>
              <p class="page-subtitle">Exclusive offers, events and privileges curated for your ${tierConfig.label} Card</p>
            </div>
          ...
          <div class="container">
            <div class="home-section" style="padding-top:0">
              ...
              <p class="carousel-header__subtitle" style="margin-bottom:20px">Explore benefits included with your ${tierConfig.label} Card</p>
          ...
          <footer class="site-footer">
            <div class="site-footer__inner">
              <div class="site-footer__brand">
                <img src="assets/logo.png" alt="Demo" class="site-footer__logo" />
