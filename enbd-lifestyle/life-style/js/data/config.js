...
const CONFIG = {
  ...
  categories: [
    ...
    { id: 'concierge',     label: 'Concierge',     icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/></svg>', color: '#CA8A04' },
  ...
  categoryHeroes: {
    ...
    entertainment: { image: 'https://images.unsplash.com/photo-1470229722913-7c0e2dbbafd3?w=1200&q=80', tagline: 'Unforgettable experiences await with your Demo card', sectionTitle: 'What\'s On Tonight', sectionDesc: 'Browse by category and area to find your ideal entertainment' },
    ...
    flights:       { image: 'https://images.unsplash.com/photo-1436491865332-7a61a109db05?w=1200&q=80', tagline: 'Fly to your dream destinations with exclusive card deals', sectionTitle: 'Compare Flight Offers', sectionDesc: 'Browse exclusive airline deals and cashback offers for cardholders' },
    ...
    concierge:     { image: 'https://images.unsplash.com/photo-1551882547-ff40c63fe5fa?w=1200&q=80', tagline: 'Your personal lifestyle concierge at your fingertips', sectionTitle: 'At Your Service', sectionDesc: 'Explore the full range of lifestyle services available to you' },
    travel:        { image: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=1200&q=80', tagline: 'Discover handpicked travel deals for cardholders', sectionTitle: 'Plan Your Getaway', sectionDesc: 'Filter by destination type to find your perfect holiday package' },
